...
{/foreach}
		...
		<form id="delete{$singular}ButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<button id="delete{$singular}Button" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Remover {$singular}</button>
	...
	<div class="modal hide fade" id="{$singular|lcfirst}DetailDialog">
		...
		<div class="modal-footer">
			...
			<button id="save{$singular}Button" class="btn btn-primary">Salvar Altera&ccedil;&otilde;es</button>
		</div>
	</div>
	...
	<p id="newButtonContainer" class="buttonContainer">
		<button id="new{$singular}Button" class="btn btn-primary">Adicionar {$singular}</button>
	</p>
