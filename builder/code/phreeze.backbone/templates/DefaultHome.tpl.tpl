...
{block name=container}
	...
	<div class="container">
		...
		<div class="hero-unit">
			...
			{/literal}
			<p><em>{$appname} foi gerada com Phreeze na vers&atilde;o {$PHREEZE_VERSION}.
			Rodando com Phreeze {ldelim}$PHREEZE_VERSION{rdelim}{ldelim}if ($PHREEZE_PHAR){rdelim} ({ldelim}$PHREEZE_PHAR|basename{rdelim}){ldelim}/if{rdelim}.</em></p>
			{literal}
